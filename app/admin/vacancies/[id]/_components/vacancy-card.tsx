            ...
            <CardContent className="flex flex-col gap-4 p-5">
                ...
                <div className="space-y-3 text-sm text-gray-700">
                    ...
                    <div className="flex items-start gap-2">
                        <MapPin className="w-5 h-5 text-blue-500 flex-shrink-0 mt-[2px]" />
                        <span>
                            <strong>Location:</strong> {student.province}, {student.district}, {student.municipality}-{student.ward}, {student.city}
                        </span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 text-sm">
                        <div className="flex items-start gap-2">
                            <BadgeInfo className="w-5 h-5 text-blue-500 flex-shrink-0 mt-[2px]" />
                            <span>
                                <strong>{student.requestType === "school" ? "Level" : "Grade"}:</strong> {student.class}
                            </span>
                        </div>
                        <div className="flex items-start gap-2">
                            <Users className="w-5 h-5 text-blue-500 flex-shrink-0 mt-[2px]" />
                            <span>
                    ...
                    {/* Time */}
                    <div className="flex items-start gap-2">
                        <CalendarClock className="w-5 h-5 text-blue-500 flex-shrink-0 mt-[2px]" />
                        <span>
                    ...
                    {/* Subject */}
                    <div className="flex items-start gap-2">
                        <BookOpenCheck className="w-5 h-5 text-blue-500 flex-shrink-0 mt-[2px]" />
                        <span>
