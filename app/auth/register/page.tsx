        ...
        <Card className="border-0 shadow-2xl">
          <CardHeader className="text-center pb-8">
            ...
            <CardDescription className="text-base">
              Join HR Home Tuition and start your learning journey
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="john.doe@example.com" required className="h-11" />
              </div>

              <div className="space-y-2">
                <Label htmlFor="phone">Phone Number</Label>
                <Input id="phone" type="tel" placeholder="+977 980-1234567" required className="h-11" />
              </div>
